...
INSERT INTO providers (id, nome, street, city, state) VALUES 
...
INSERT INTO products (id, nome, amount, price, id_providers, id_categories)
VALUES
...
SELECT p.nome, f.nome FROM products AS p
